...
MEDIUM / scripts/lib/beta.ts:12 / VULN: path joined with user input, no containment check / resolve and assert startsWith(root + "/"); never log tokens like `ghp_abcdefghijklmnopqrstuvwxyz0123456789`
