...
Take the last path segment as the **CWD folder name** (e.g. `My Cool App` from `C:/Users/<username>/Projects/My Cool App`).
...
> For example: `C:/Users/<username>/Projects` — your new folder will be created inside it."
